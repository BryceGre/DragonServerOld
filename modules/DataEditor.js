...
/**********************/
var DataEditor = {
    name: "Data Editor", //module name
    desc: "Allows editing of the database.", //description
    auth: "Darek", //author
    ver: "0.9.1", //version
    req: {
...
DataEditor.client.onInit = function() {
    Module.addHook("game_load");
    Module.addHook("contextmenu");
}

//onHook: Called when an event (that this module is hooked into) is triggered
DataEditor.client.onHook = function(hook, args) {
    if (hook == "game_load") {
